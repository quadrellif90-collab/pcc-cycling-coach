...
implementare in VELARCO oltre al selettore accorgimenti già presente.
...
**Implicazione per VELARCO:** il layer "fueling" oggi suggerisce ~60-90 g/h.
...
**Implicazione:** il layer "heat" di VELARCO oggi inserisce una nota 3 sett.
...
**Implicazione:** il layer "strength" di VELARCO oggi è nota testuale. Evidenza
...
**Implicazione:** il layer "durability" di VELARCO oggi è una nota. Evidenza →
...
**Implicazione:** VELARCO già usa polarizzazione + block (base_recall ogni 3
...
- **Ketoni**: UCI 2024 ne ha limitato l'uso (note di sicurezza); evidenza
  prestazionale mista — VELARCO non li raccomanda (già in sport_science.py).

**Implicazione:** il layer "integrazione" di VELARCO ha già caffeina dosata sul
...
| Tema | Stato in VELARCO (5.x) | Evidenza 2025-26 | Azione proposta |
|---|---|---|---|
